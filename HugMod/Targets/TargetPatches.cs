...
namespace HugMod.Targets
{
    ...
    public class TargetPatches
    {
        ...
        {
            if (!GabbroHug.IsSequenceInProgress()) return true;
        ...
        {
            if (!SolanumHug.IsSequenceInProgress()) return true;
        ...
        {
            if (__instance._currentBehavior == PrisonerBehavior.MoveToElevatorDoor) PrisonerHug.SetHugEnabled(false);
            return true;
        }
